...
const Home = () => {
    ...
    return (<>
            ...
            <Box   color="#000000" bgcolor="#FFF8E6"
                         sx={{borderRadius: 4, flexGrow: 1, flexDirection: "column", padding: "15px", marginTop: "35px",
                         marginBottom: "5px", marginLeft: "5px", marginRight: "5px"}}>
                        <Stack>
                            <Box>
                                <Typography variant="h6" display="inline" sx={{
                                lineHeight: "32px",
                                marginBottom: "15px"
                            }}>How to use Scil</Typography>
                            </Box>
...
If you are using Scil with GitLab, click on the Login button in the top right. You will be prompted to enter a GitLab private key.
                    ...
                    <Box   color="#000000" bgcolor="#FFF8E6"
                         sx={{borderRadius: 4, flexGrow: 1, flexDirection: "column", padding: "15px", marginTop: "5px",
                         marginBottom: "5px", marginLeft: "5px", marginRight: "5px"}}>
                        <Stack>
                            <Box>
                                <Typography variant="h6" display="inline" sx={{
